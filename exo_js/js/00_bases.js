...
//point-virgule, aussi il est possible d'écrire plusieurs instruction sur
// une seule ligne
// inst_1;
// inst_2; inst_3;
...
// --5  : Afficher dans la console (ici, la valeur de ma varible Prenom)
//console.log(Prenom);
...
// var jour = prompt("Question : on est quel jour ?", "jour de la
//semaine");
//console.log(jour);
...
// --9 : Une variable ne peut pas commencer par un chiffre, ne doit contenir que des caractères ap=lphanumériques, et ne peut pas être unmot réservé (var, for ... des éléments natifs du langage JS).
 ...
 // --5. Les Constantes
 /*La déclaration const permet de créer une constante accessible uniquement en lecture. Contrairement à une variable sa valeur ne peut plis être modifiée par réaffectation plus bas dans le code. Une constante ne peut pas être déclarée à nouveau dans le même script*/
